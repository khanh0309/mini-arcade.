const fallbackGames = [
  ...
  {id:'racing',name:'Road Rush',icon:'🏎️',tag:'Racing',description:'Lái xe né ô tô và chướng ngại vật khi tốc độ tăng dần.',path:'./games/racing/',accent:'#ff9f43',storageKey:'arcade_best_racing',scoreLabel:'Quãng đường'},
